...
#http://registrationcenter-download.intel.com/akdlm/irc_nas/tec/12070/l_mkl_2018.0.128.tgz -c 
import numpy as np 
import dlib
import Image
import cv2 
...
history = model.fit(X_train, y_train, batch_size=5, nb_epoch=150, verbose=1, validation_data=(X_test,y_test))
model.save('kaggle_images/male_and_female_100Epochs.h5')
